...
_EXPORT_MODULES = {
    ...
    "LOCAL_TRACK_FEATURE_DIM": "controller_learning.rl.features",
    "LOCAL_TRACK_FEATURE_SCHEMA_VERSION": "controller_learning.rl.features",
    "LocalTrackObservationVecEnv": "controller_learning.rl.features",
    "encode_local_track_features_jax": "controller_learning.rl.features",
    "encode_local_track_features_numpy": "controller_learning.rl.features",
    "PUBLIC_REWARD_SCHEMA_VERSION": "controller_learning.rl.reward",
    "PublicRewardShapingVecEnv": "controller_learning.rl.reward",
